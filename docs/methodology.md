...
After `pk setup`, run `/pk-configure` to write `.pk.json`, and Claude Code's built-in `/init` to add project-specific conventions. See [Customize your CLAUDE.md](pk-setup.md#customize-your-claudemd).
